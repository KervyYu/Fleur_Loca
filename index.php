          ...
          <div class="col-lg-4">
            <div class="review">
              <div class="person">
                <img src="images/avatar1.jpg" alt="">
                <div class="text ms-3">
                  <h6 class="mb-0">Alex & Sean</h6>
                  <small>Instagram</small>
                </div>
              </div>
              <p class>Thankyou so much! You got so many compliments for all the arrangements! they're absolutely beautiful and we could not have asked for anything more!</p>
            </div>
          </div>
